...
// busFeedUrl: URL of the deployed live-buses proxy (see LIVE_BUSES.md). Leave empty and
// the live-bus layer stays hidden. Never put the BusTime API key itself here.
