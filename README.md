...
**Top 10 on campus and top 10 off campus** ([`outputs/priority_on_off_campus.md`](outputs/priority_on_off_campus.md), and two chips in the app view). The main ranking is dominated by University of Florida campus stops: 19 of the top 20 are on campus. So the rest of Gainesville is not crowded out, each side gets its own top 10, ranked with the same score. On campus means inside, or within 5 m of, the OpenStreetMap boundary of the University of Florida (5 m absorbs boundary-drawing error, since stops named for UF buildings sit 1 to 5 m outside the drawn line). 103 stops are on campus and 868 are off campus, and the off-campus stops carry 74 percent of weekday bus visits. The off-campus top 10 ranks 14th to 35th in the citywide list. Off campus includes student apartment complexes near campus, and shelter status is OpenStreetMap-based and partial.
